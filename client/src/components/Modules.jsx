        ...
        <ol className="list-inside list-decimal text-[4vw]">
            <li>
                ...
                <div class="text-[1vw] ml-[3vw] p-4">
                    <p className='w-[80%]'>Networking is the process of making connections and building relationships. These connections can provide you with advice and contacts, which can help you make informed career decisions.</p>
